    ...
    <div class="col-span-10 p-5 h-screen overflow-y-scroll relative" scroll-region>
      ...
      >
        <div class="flex items-center">
          ...
          <input
            type="text"
            class="ml-2 bg-inherit focus:outline-none w-[300px]"
        ...
        <div class="flex justify-end items-center gap-4">
          ...
          <a href="" class="relative">
            <span
              class="absolute right-0 w-[13px] h-[13px] flex justify-center items-center text-white text-[8px] rounded-full bg-red-500"
              >0</span
            >
            <svg
              xmlns="http://www.w3.org/2000/svg"
